...
struct ContentView: View {
    ...
    @State private var editingItem: TestRecord?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Emissions Test Reminder")
            .toolbar {
    ...
    private func editSheet(for item: TestRecord) -> some View {
